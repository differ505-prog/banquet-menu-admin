    ...
    entries: [
      {
        label: "傳統蒸蛋（平滑如鏡）",
        cuisine: "中式",
        goldenRatio: "蛋液 : 室溫水 = 1 : 2.5（鹽佔蛋液 0.5% 起）",
        coreTechnique: "中微火蒸 8–10 分鐘，蛋液過篩、淺盤廣布、鍋蓋留縫",
        steps: `過篩：蛋液一定要用細篩網過篩 2 次，徹底去除氣泡與蛋繫帶，這是表面如鏡的關鍵。
水量控制：蛋水比 1:2.5 是最平滑不老的比例；水太多容易出水，水太少則組織乾硬。
微火慢蒸：冷水下鍋，水大滾後轉「中微火」（約 90–95°C），水面冒小氣泡而非滾沸。淺盤廣布：蛋液厚度不超過 2.5cm，容器愈淺愈均勻。鍋蓋留縫：用一根筷子墊在鍋蓋下讓蒸氣微量外洩，避免上方凝結的水滴滴回蛋面造成蜂窩與麻臉。
判斷熟度：輕搖容器，中心微微晃動即為最佳熟度（類似嫩豆腐口感）。`,
        troubleshooting: {
          problem: "表面有蜂窩孔洞，或底部出現一圈老化的硬層？",
          solution:
            "蜂窩是蒸氣太旺或蛋液沒過篩；硬底則是火力過大或蒸太久。中微火 + 鍋蓋留縫 + 蛋液過篩，三者缺一不可。若已有蜂窩，可在上桌前輕輕倒掉表面的水，再補一小勺香油恢復光澤。",
        },
        score: 9.3,
      },
      {
